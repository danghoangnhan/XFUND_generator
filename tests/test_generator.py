...
class TestUtilities:
    ...
    def test_bbox_operations(self):
        ...
        if hasattr(utils, 'BBox'):
            ...
            assert bbox.area() == 20000  # (300-100) * (400-200)
    ...
    def test_field_name_normalization(self):
        ...
        if hasattr(utils, 'normalize_field_name'):
            ...
            assert utils.normalize_field_name("Patient") == "patient"
        else:
...
class TestRenderer:
    ...
    def test_create_sample_layout(self):
        ...
        if hasattr(renderer, 'create_sample_layout'):
            ...
            # Check bbox format
            for field, bbox in layout.items():
                assert len(bbox) == 4
...
class TestValidationFunctions:
    ...
    def test_annotation_validation_structure(self):
        ...
        invalid_annotations = [
            ...
            {"text": "Test", "bbox": [50, 30, 10, 10], "label": "test_field"},  # Invalid bbox
        ]
