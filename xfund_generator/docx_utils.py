...
class DocxProcessor:
    ...
    def fill_template(
        ...
        if output_path is None:
            output_path = os.path.join(
                tempfile.gettempdir(), 
                f"filled_{self.template_name}_{id(data)}.docx"
            )
    ...
    def _replace_placeholders_in_paragraphs(self, doc: Document, data: Dict[str, str]) -> None:
    ...
    def _replace_placeholders_in_tables(self, doc: Document, data: Dict[str, str]) -> None:
    ...
    def _replace_placeholders_in_headers_footers(self, doc: Document, data: Dict[str, str]) -> None:
    ...
    def convert_to_png(
        ...
        try:
            ...
            if os.path.exists(pdf_path) and pdf_path != png_path.replace('.png', '.pdf'):
                os.remove(pdf_path)
